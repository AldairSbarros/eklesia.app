...
const API_KEY = "08ec58ad-6946-4712-bd89-2b50ce35c909";

// Função utilitária para identificar o livro corretamente
...
function BibleReader() {
  ...
  // Buscar bíblias ao selecionar idioma
  useEffect(() => {
    setBiblia("");
    setLivros([]);
    setLivro("");
  ...
  // Buscar livros e filesets ao selecionar bíblia
  useEffect(() => {
    setLivros([]);
    setLivro("");
    setVersiculos([]);
  ...
  // Buscar conteúdo ao selecionar livro/capítulo
